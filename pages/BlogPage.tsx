  ...
  return (
    <div className="bg-gray-900 py-16 sm:py-24 min-h-[60vh] flex items-center justify-center">
      <div className="container mx-auto px-6 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white">บทความ / บล็อก</h1>
        <p className="mt-4 text-lg text-gray-400 max-w-3xl mx-auto">
          เร็วๆ นี้! ติดตามบทความเชิงลึกและอัปเดตเทรนด์ล่าสุดเกี่ยวกับเทคโนโลยี Storage และ ERP ได้ที่นี่
        </p>
        <div className="mt-12">
